...
import com.zwd.crm.base.BaseIndexTagBean;
...
public class ChooseTitleItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public ChooseTitleItemDecoration(Context context, List<ChoosePersonGet> datas) {
        ...
        mTitleHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 14, context.getResources().getDisplayMetrics());
