        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    quxiao = (TextView)mItemLayout.findViewById(R.id.quxiao);
                    mLL = (LinearLayout)mItemLayout.findViewById(R.id.ll);
                    mDelete = (TextView) mItemLayout.findViewById(R.id.item_delete);
                    mMaxLength = mLL.getWidth();
